...
<head>
    ...
    <body class="account-pages">
        ...
        <!-- Begin page -->
        <div class="accountbg" style="background: url('Dashboard/assets/images/bg-1.jpg');background-size: cover;background-position: center;"></div>
                        ...
                        <div class="card-box p-5">
                            <h2 class="text-uppercase text-center pb-4">
                                <a href="index.html" class="text-success">
                                    <span><img src="Dashboard/assets/images/logo.png" alt="" height="26"></span>
                                </a>
                            </h2>
